...
from supermemory.types.shared import ProfileResponse
...
class TestShared:
    ...
    def test_method_profile(self, client: Supermemory) -> None:
        shared = client.shared.profile(
            container_tag="containerTag",
        )
        assert_matches_type(ProfileResponse, shared, path=["response"])
    ...
    def test_raw_response_profile(self, client: Supermemory) -> None:
        response = client.shared.with_raw_response.profile(
            container_tag="containerTag",
        )
    ...
    def test_streaming_response_profile(self, client: Supermemory) -> None:
        with client.shared.with_streaming_response.profile(
            container_tag="containerTag",
        ) as response:
...
class TestAsyncShared:
    ...
    async def test_method_profile(self, async_client: AsyncSupermemory) -> None:
        shared = await async_client.shared.profile(
            container_tag="containerTag",
        )
        assert_matches_type(ProfileResponse, shared, path=["response"])
    ...
    async def test_raw_response_profile(self, async_client: AsyncSupermemory) -> None:
        response = await async_client.shared.with_raw_response.profile(
            container_tag="containerTag",
        )
    ...
    async def test_streaming_response_profile(self, async_client: AsyncSupermemory) -> None:
        async with async_client.shared.with_streaming_response.profile(
            container_tag="containerTag",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
